...
- `<!-- PROPS -->` placeholder for props table. There are some issue with props parsing. Here is small clarification [issue#137](https://github.com/tuchk4/storybook-readme/issues/137#issuecomment-481307652)
